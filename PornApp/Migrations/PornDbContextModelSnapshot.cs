...
{
    [DbContext(typeof(PornDbContext))]
    partial class PornDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PornApp.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PornApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PornApp.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PornApp.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PornApp.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PornApp.Models.OrderDetail", b =>
                {
                    b.HasOne("PornApp.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PornApp.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PornApp.Models.Pie", b =>
                {
                    b.HasOne("PornApp.Models.Category", "Category")
                        .WithMany("Pies")
